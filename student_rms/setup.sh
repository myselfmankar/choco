...
# --- Assignment 8: Student RMS Zero-to-End Setup ---

echo " Starting Student RMS Setup ..."
...
NGINX_CONF="/etc/nginx/sites-available/student_rms"
...
echo " To start the Student RMS server, run:"
echo "   python3 app.py"
