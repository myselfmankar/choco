...
# --- Assignment 10: E-commerce Store Zero-to-End Setup ---

echo " Starting E-commerce Store Setup ..."
...
NGINX_CONF="/etc/nginx/sites-available/ecommerce_app"
...
echo " To start the E-commerce server, run:"
echo "   python3 app.py"
