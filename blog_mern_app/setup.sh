...
# --- Proper MERN Assignment: VM Provisioning Script ---
...
# 4. MongoDB Official Repository (Robust for 22.04/24.04)
...
PROJECT_DIR=$(pwd)
NGINX_CONF="/etc/nginx/sites-available/mern_blog"
...
server {
    ...
    # 2. Proxy API requests to Node backend
    location /api/ {
...
echo "----------------------------------------------------"
echo "✅ SETUP COMPLETE! BLOG PLATFORM IS LIVE."
echo "----------------------------------------------------"
echo "🌎 Frontend: Serve by Nginx on Port 80"
echo "⚙️  Backend: Managed by PM2 (blog-api)"
echo ""
echo "Manage your stack with these commands:"
echo " - View status: pm2 status"
echo " - View logs:   pm2 logs blog-api"
echo " - Restart all: pm2 restart all"
echo " - DB Access:   mongosh blog_db"
echo "----------------------------------------------------"
