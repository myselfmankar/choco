...
echo "Starting Student Portal Services..."
cd $PROJECT_DIR
pm2 start backend/server.js --name "student-api"
pm2 save

echo "----------------------------------------------------"
echo "✅ SETUP COMPLETE! STUDENT PORTAL IS LIVE."
echo "----------------------------------------------------"
echo "🌎 Frontend: Serve by Nginx on Port 80"
echo "⚙️  Backend: Managed by PM2 (student-api)"
echo ""
echo "Manage your stack with these commands:"
echo " - View status: pm2 status"
echo " - View logs:   pm2 logs student-api"
echo " - Restart all: pm2 restart all"
echo " - DB Access:   mongosh student_db"
echo "----------------------------------------------------"
